...
<section class="mb-4">
    <h2 class="h6 text-muted text-uppercase fw-bold mb-2"><i class="fa-solid fa-sun me-1"></i> Today at a glance</h2>
    <div class="row g-2">
        <div class="col-6">
...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <a href="{{ $cards['orders_30']['url'] }}" class="operator-stat-card bg-body">
    ...
    <div class="col-md-4">
        <a href="{{ $cards['pos_sales']['url'] }}" class="operator-stat-card bg-body">
            <div class="d-flex justify-content-between align-items-start mb-2">
    ...
    <div class="col-md-4">
        <a href="{{ $cards['inventory_alerts']['url'] }}" class="operator-stat-card bg-body {{ $cards['inventory_alerts']['count'] > 0 ? 'border-warning' : '' }}">
            <div class="d-flex justify-content-between align-items-start mb-2">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <a href="{{ route('operator.wallet') }}" class="small">View wallet</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
